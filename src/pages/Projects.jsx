...
// function ProjectCell({ name, text, color, screen }) {
//   return (
//     <>
//       <div
//         style={{ backgroundColor: color }}
//         className="group  flex-col rounded-xl mx-[5%] my-[5%]"
//       >
//         <div className="  pt-[20px] parent ">
...
//           }
//           className="mt-[-4%]  child md:translate-x-[100%] text-center text-xs md:text-sm font-montserrat md:inline-block text-white md:w-[60%] py-[4%] px-[8%] md:rounded-lg md:transition-ease-in-out"
//         >
//           {text}
//         </p>
//       </div>
...
//   return (
//     <>
//       <div className="text-center font-poppins border-t-[10px] md:border-t-[25px] border-b-[10px] md:border-b-[25px] py-[6%] border-enacblk text-xl md:text-5xl font-bold bg-[url('/images/YellowBG.png')]">
//         OUR PROJECTS
//       </div>
//       <div className="mt-[5%]">
