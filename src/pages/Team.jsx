...
const Team = () => {
  const teamMembers = [
    { 
        ...
        image: "https://plus.unsplash.com/premium_photo-1678197937465-bdbc4ed95815?q=80&w=2787&auto=format&fit=crop&ixlib=rb-4.0.3", 
    ...
    { 
        ...
        description: "Specializes in creating efficient and scalable backend systems.", 
        image: "https://plus.unsplash.com/premium_photo-1664536392896-cd1743f9c02c?q=80&w=2787&auto=format&fit=crop&ixlib=rb-4.0.3", 
    ...
    { 
        ...
        description: "Expert in automating and optimizing infrastructure for cloud-based applications.", 
        image: "https://plus.unsplash.com/premium_photo-1689539137236-b68e436248de?q=80&w=2942&auto=format&fit=crop&ixlib=rb-4.0.3", 
    ...
    { 
        name: "Dana Evans", 
        role: "UI/UX Designer", 
        description: "Combines creative design with user research to create visually appealing and user-friendly interfaces.", 
        image: "https://plus.unsplash.com/premium_photo-1671656349322-41de944d259b?q=80&w=2787&auto=format&fit=crop&ixlib=rb-4.0.3", 
    ...
    { 
        name: "Evan Thomas", 
        role: "Data Scientist", 
        description: "Skilled in machine learning and data analysis, focusing on extracting insights from complex data sets.", 
        image: "https://plus.unsplash.com/premium_photo-1689539137236-b68e436248de?q=80&w=2942&auto=format&fit=crop&ixlib=rb-4.0.3", 
    ...
    { 
        ...
        description: "Expert in agile methodologies and project management, ensuring timely and efficient delivery of projects.", 
        image: "https://plus.unsplash.com/premium_photo-1671656349322-41de944d259b?q=80&w=2787&auto=format&fit=crop&ixlib=rb-4.0.3", 
                  ...
                  <div className="absolute inset-0 p-4 text-left font-moderniz h-auto flex flex-col justify-end items-start bg-opacity-50  text-white">
                    <div className='bg-white p-3 rounded-md bg-opacity-75 transition hover:bg-opacity-100'>
                      ...
                      <div className="flex justify-left items-center space-x-5 text-gray-200 mt-3 w-full h-auto">
                        <FacebookIcon className="text-blue-600 scale-125" onClick={() => {
                          window.open(member.facebook);
                        }} />
                        <InstagramIcon className="text-pink-500 scale-110" onClick={() => {
                          window.open(member.instagram);
                        }} />
                        <XIcon className="text-black" onClick={() => {
